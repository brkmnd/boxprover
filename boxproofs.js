var BoxProofs = function(){
    ...
    var addToken2tree = function(tree,node){
        _token(node,{
            "name":function(tokenType,tokenVal){
                tree.push({type:"name",v:tokenVal});
                }
           });
        return tree;
        };
    ...
    var productions_fun = {
        ...
        //[5] LinesOptEnd -> scolon Naming Lines 
        5:function(tree){
            var lines = tree.pop();
            var name = tree.pop();
            tree.push({type:"eol",name:name.v,lines:lines.lines});
        ...
        //[14] RuleApply -> copy name 
        14:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["copy"],args:[arg]});
            return tree;
            },
        //[15] RuleApply -> eq_e Bind name name 
        15:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            //throw away for now.
        ...
        //[20] RuleApply -> all_i name 
        20:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["all","i"],args:[arg]});
            return tree; },
        //[21] RuleApply -> mt name name 
        21:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"rule",name:["mt"],args:[arg1,arg2]});
            return tree; },
        //[22] RuleApply -> pbc name 
        22:function(tree){
            var arg = tree.pop();
        ...
        23:function(tree){
            ...
            return tree; },
        //[24] RuleApply -> nni name 
        24:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["nn","i"],args:[arg]});
            return tree; },
        //[25] RuleApply -> nne name 
        25:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["nn","e"],args:[arg]});
            return tree; },
        //[26] RuleApply -> bot_e name 
        26:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["bot","e"],args:[arg]});
            return tree; },
        //[27] RuleApply -> neg_e name name 
        27:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"rule",name:["neg","e"],args:[arg1,arg2]});
            return tree; },
        //[28] RuleApply -> neg_i name 
        28:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["neg","i"],args:[arg]});
            return tree; },
        //[29] RuleApply -> imp_e name name 
        29:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"rule",name:["imp","e"],args:[arg1,arg2]});
            return tree; },
        //[30] RuleApply -> imp_i name 
        30:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["imp","i"],args:[arg]});
            return tree; },
        //[31] RuleApply -> dis_e name name name 
        31:function(tree){
            var arg3 = tree.pop();
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"rule",name:["dis","e"],args:[arg1,arg2,arg3]});
            return tree; },
        //[32] RuleApply -> dis_i2 name 
        32:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["dis","i2"],args:[arg]});
            return tree; },
        //[33] RuleApply -> dis_i1 name 
        33:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["dis","i1"],args:[arg]});
            return tree; },
        //[34] RuleApply -> con_e2 name 
        34:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["and","e","2"],args:[arg]});
            return tree; },
        //[35] RuleApply -> con_e1 name 
        35:function(tree){
            var arg = tree.pop();
            tree.push({type:"rule",name:["and","e","1"],args:[arg]});
            return tree; },
        //[36] RuleApply -> con_i name name 
        36:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"rule",name:["and","i"],args:[arg1,arg2]});
            return tree; },
        //[37] RuleApply -> top_i 
        37:function(tree){
            tree.push({type:"rule",name:["top","i"],args:[]});
            return tree; },
        //[38] Naming -> lbracket name rbracket 
        38:function(tree){ return tree; },
        //[39] Formula -> Atom 
        39:function(tree){ return tree; },
        //[40] Formula -> not Formula 
        40:function(tree){
            var arg = tree.pop();
        ...
        //[43] Formula -> Formula eq Formula 
        43:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"connective",name:"eq",args:[arg1,arg2]});
            return tree;
            },
        //[44] Formula -> Formula imp Formula 
        44:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"connective",name:"imp",args:[arg1,arg2]});
            return tree;
            },
        //[45] Formula -> Formula or Formula 
        45:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"connective",name:"or",args:[arg1,arg2]});
            return tree;
            },
        //[46] Formula -> Formula and Formula 
        46:function(tree){
            var arg2 = tree.pop();
            var arg1 = tree.pop();
            tree.push({type:"connective",name:"and",args:[arg1,arg2]});
            return tree;
            },
        //[47] Bind -> lpar Naming Formula rpar 
        47:function(tree){
            var formula = tree.pop();
            var bvar = tree.pop();
        ...
        //[51] OptArgs -> lpar Formula rpar OptArgs 
        51:function(tree){
            var f = tree.pop();
            var arg = tree.pop();
            f.args.push(arg);
    ...
    var productions_str = {
        ...
        4:{prod:"LinesOptEnd",rside:[ "Naming","Lines"]},
        5:{prod:"LinesOptEnd",rside:[ "scolon","Naming","Lines"]},
        6:{prod:"Line",rside:[ "uscore"]},
        7:{prod:"Line",rside:[ "lpar","Box","rpar"]},
        8:{prod:"Line",rside:[ "Formula","Rule"]},
        9:{prod:"Rule",rside:[ "by","RuleApply"]},
        10:{prod:"Rule",rside:[ "assump"]},
        11:{prod:"Rule",rside:[ "prem"]},
        12:{prod:"Box",rside:[ "Lines"]},
        13:{prod:"Box",rside:[ "var","Naming","Lines"]},
        14:{prod:"RuleApply",rside:[ "copy","name"]},
        15:{prod:"RuleApply",rside:[ "eq_e","Bind","name","name"]},
        16:{prod:"RuleApply",rside:[ "eq_i"]},
        17:{prod:"RuleApply",rside:[ "exi_e","name","name"]},
        18:{prod:"RuleApply",rside:[ "exi_i","name","name"]},
        19:{prod:"RuleApply",rside:[ "all_e","name","name"]},
        20:{prod:"RuleApply",rside:[ "all_i","name"]},
        21:{prod:"RuleApply",rside:[ "mt","name","name"]},
        22:{prod:"RuleApply",rside:[ "pbc","name"]},
        23:{prod:"RuleApply",rside:[ "lem"]},
        24:{prod:"RuleApply",rside:[ "nni","name"]},
        25:{prod:"RuleApply",rside:[ "nne","name"]},
        26:{prod:"RuleApply",rside:[ "bot_e","name"]},
        27:{prod:"RuleApply",rside:[ "neg_e","name","name"]},
        28:{prod:"RuleApply",rside:[ "neg_i","name"]},
        29:{prod:"RuleApply",rside:[ "imp_e","name","name"]},
        30:{prod:"RuleApply",rside:[ "imp_i","name"]},
        31:{prod:"RuleApply",rside:[ "dis_e","name","name","name"]},
        32:{prod:"RuleApply",rside:[ "dis_i2","name"]},
        33:{prod:"RuleApply",rside:[ "dis_i1","name"]},
        34:{prod:"RuleApply",rside:[ "con_e2","name"]},
        35:{prod:"RuleApply",rside:[ "con_e1","name"]},
        36:{prod:"RuleApply",rside:[ "con_i","name","name"]},
        37:{prod:"RuleApply",rside:[ "top_i"]},
        38:{prod:"Naming",rside:[ "lbracket","name","rbracket"]},
        39:{prod:"Formula",rside:[ "Atom"]},
        40:{prod:"Formula",rside:[ "not","Formula"]},
        41:{prod:"Formula",rside:[ "exi","Bind"]},
        42:{prod:"Formula",rside:[ "all","Bind"]},
        43:{prod:"Formula",rside:[ "Formula","eq","Formula"]},
        44:{prod:"Formula",rside:[ "Formula","imp","Formula"]},
        45:{prod:"Formula",rside:[ "Formula","or","Formula"]},
        46:{prod:"Formula",rside:[ "Formula","and","Formula"]},
        47:{prod:"Bind",rside:[ "lpar","Naming","Formula","rpar"]},
        48:{prod:"Atom",rside:[ "name","OptArgs"]},
        49:{prod:"Atom",rside:[ "lpar","Formula","rpar"]},
        50:{prod:"OptArgs",rside:[]},
        51:{prod:"OptArgs",rside:[ "lpar","Formula","rpar","OptArgs"]},
        52:{prod:"OptArgs",rside:[ "name","OptArgs"]}
        };
    ...
    var actionTable = {
        ...
        1:{
            "and":actionType.reduce(39),
            "or":actionType.reduce(39),
            "imp":actionType.reduce(39),
            "not":actionType.error(),
            "eq":actionType.reduce(39),
            "prem":actionType.reduce(39),
            "assump":actionType.reduce(39),
            "all_e":actionType.error(),
            "all_i":actionType.error(),
            "bot_e":actionType.error(),
            "con_e1":actionType.error(),
        ...
        3:{
            ...
            "lbracket":actionType.shift(22),
            "rbracket":actionType.error(),
            "uscore":actionType.error(),
            "scolon":actionType.shift(23),
            "dot":actionType.shift(21),
            "name":actionType.error(),
            "$":actionType.reduce(2)
            },
        4:{
        ...
        10:{
            ...
            "lbracket":actionType.reduce(6),
            "rbracket":actionType.error(),
            "uscore":actionType.error(),
            "scolon":actionType.reduce(6),
            "dot":actionType.reduce(6),
            "name":actionType.error(),
            "$":actionType.reduce(6)
            },
        11:{
        ...
        14:{
            ...
            "prem":actionType.error(),
            "assump":actionType.error(),
            "all_e":actionType.shift(38),
            "all_i":actionType.shift(39),
            "bot_e":actionType.shift(40),
            "con_e1":actionType.shift(41),
            "con_e2":actionType.shift(42),
            "con_i":actionType.shift(43),
            "dis_e":actionType.shift(45),
            "dis_i1":actionType.shift(46),
            "dis_i2":actionType.shift(47),
            "eq_e":actionType.shift(48),
            "eq_i":actionType.shift(49),
            "exi_e":actionType.shift(50),
            "exi_i":actionType.shift(51),
            "imp_e":actionType.shift(52),
            "imp_i":actionType.shift(53),
            "neg_e":actionType.shift(56),
            "neg_i":actionType.shift(57),
            "nne":actionType.shift(58),
            "nni":actionType.shift(59),
            "pbc":actionType.shift(60),
            "top_i":actionType.shift(61),
            "var":actionType.error(),
            "all":actionType.error(),
            "exi":actionType.error(),
            "lem":actionType.shift(54),
            "mt":actionType.shift(55),
            "by":actionType.error(),
            "copy":actionType.shift(44),
            "lpar":actionType.error(),
            "rpar":actionType.error(),
            "lbracket":actionType.error(),
            "rbracket":actionType.error(),
        ...
        81:{
            ...
            "lbracket":actionType.reduce(14),
            "rbracket":actionType.error(),
            "uscore":actionType.error(),
            "scolon":actionType.reduce(14),
            "dot":actionType.reduce(14),
            "name":actionType.error(),
    ...
    var gotoTable = {
        ...
        3:{
            "Lines":actionType.none(),
            "LinesOptEnd":actionType.some(19),
            "Line":actionType.none(),
            "Rule":actionType.none(),
            "Box":actionType.none(),
            "RuleApply":actionType.none(),
            "Naming":actionType.some(20),
            "Formula":actionType.none(),
            "Bind":actionType.none(),
            "Atom":actionType.none(),
            "OptArgs":actionType.none()
        ...
        6:{
            ...
            "Naming":actionType.none(),
            "Formula":actionType.none(),
            "Bind":actionType.some(26),
            "Atom":actionType.none(),
            "OptArgs":actionType.none()
            },
        7:{
            "Lines":actionType.some(29),
            "LinesOptEnd":actionType.none(),
            "Line":actionType.some(3),
            "Rule":actionType.none(),
            "Box":actionType.some(27),
            "RuleApply":actionType.none(),
            "Naming":actionType.none(),
            "Formula":actionType.some(28),
            "Bind":actionType.none(),
            "Atom":actionType.some(1),
            "OptArgs":actionType.none()
            },
